config = {
	...
	'sensors':{
		'humidity':{ #Valores 
			...
			'good': 300,
			'much': 160,
			'twitter_post': [(10,30),(12,10), (18,00)],
			'instagram_post': [(10,40),(12,11), (18,10), (18,16)],
			'telegram_post': [(10,00), (12,12),(18,20)],
		},
		'temperature':{ #C°
			'active': True,
			'bad': 15,
			...
			'good': 22,
			'much': 30,
			'twitter_post': [(10,35), (12,5),(18,5)],
			'instagram_post': [(10,45),(12,6), (18,15)],
			'telegram_post': [(10,5), (12,7),(18,25)],
		},
		'light':{ #Horas luz
			'active': True,
			'bad': 8,
		...
		'ambient':{ # Humedad Ambiental
			...
			'good': 85,
			'much': 90,
			'twitter_post': [(6,35), (12,15), (18,35)],
			'instagram_post': [(6,40), (12,16), (18,40)],
			'telegram_post': [(6,45), (12,17) ,(18,45)],
		},
	},
}
